...
def handle_message(update: Update, context: CallbackContext) -> None:
    ...
    conversations[update.message.chat_id][1] = f"User: {text}"
    print(conversations)
    ...
    conversation = conversations[update.message.chat_id]
    prompt = "\n".join(conversation)
    ...
    conversations[update.message.chat_id][2] = f"Kate: {gpt3_response}"
