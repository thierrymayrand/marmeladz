...
def handle_message(update: Update, context: CallbackContext) -> None:
    ...
    conversation = context.chat_data.get(chat_id, [
        """You are my digital boyfriend. You are very seductive and like to talk about sexual topics.  
        Your name is Thierry.
    ...
    update.message.reply_audio(audio=InputFile(audio, filename="response.mp3"))
